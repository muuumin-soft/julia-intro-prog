...
@testset "名前表示調整" begin
    描画ツール = create描画ツール()
    @test 名前表示調整("a", 描画ツール) == "a               "    
    @test 名前表示調整("ab", 描画ツール) == "ab              "    
    @test 名前表示調整("あ", 描画ツール) == "あ              "
    @test 名前表示調整("太郎", 描画ツール) == "太郎            "
    @test 名前表示調整("tarou", 描画ツール) == "tarou           "
    @test 名前表示調整("1234567890123456", 描画ツール) == "1234567890123456"
    @test 名前表示調整("ドラゴン", 描画ツール) == "ドラゴン        "
    @test 名前表示調整("ドラゴンドラゴン", 描画ツール) == "ドラゴンドラゴン"
end
